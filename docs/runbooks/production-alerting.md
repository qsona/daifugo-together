...
告知後 1〜2 時間は Discord 通知に加えて `fly logs --app daifugo-together` を開き、`uncaught_exception`、`socket_internal_error`、`rule_auto_disabled`、`rule_load_failure`、`ai_fallback` を確認する。
