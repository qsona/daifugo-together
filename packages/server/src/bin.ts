    ...
    onAiLog: (log) => {
      ...
      if (log.fallback !== 'none') {
        writeLog('info', 'ai_fallback', {
          ...
          worlds: log.worlds,
          rootCandidates: log.rootCandidates,
          candidateEvaluations: log.candidateEvaluations,
          simulatedSteps: log.simulatedSteps,
          dangerousPlayFilters: log.dangerousPlayFilters,
          queueMs: log.queueMs,
          setupMs: log.setupMs,
          searchMs: log.searchMs,
          workerReused: log.workerReused,
          ruleIds: log.ruleIds,
