...
const modules: RuleModule[] = [eightCut, sevenPass, bomberman];
...
describe('ルール間の追加入力', () => {
  it.each([
    { afterSequence: 4, afterSevenPass: 3, bombermanCount: 3 },
    { afterSequence: 5, afterSevenPass: 4, bombermanCount: 4 },
  ])(
    '6789後に$afterSequence枚なら7渡し後の$afterSevenPass枚からボンバーマンで$bombermanCount枚を選ぶ',
    ({ afterSequence, afterSevenPass, bombermanCount }) => {
